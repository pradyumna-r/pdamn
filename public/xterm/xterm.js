  ...
  (() => {
    ...
    var e = {
        4567: function (e, t, i) {
          ...
          let _ = class extends h.Disposable {
            constructor(e, t) {
              ...
              if (
                ...
                (this._liveRegionDebouncer = this.register(
                  new a.TimeBasedDebouncer(this._announceCharacters.bind(this))
                )),
            ...
            _handleBoundaryFocus(e, t) {
              const i = e.target,
                s =
                  this._rowElements[0 === t ? 1 : this._rowElements.length - 2];
              if (
        ...
        3614: (e, t) => {
          ...
          function r(e, t, r) {
            (e = s((e = i(e)), r.decPrivateModes.bracketedPasteMode)),
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.handlePasteEvent = function (e, t, i) {
              e.stopPropagation(),
                e.clipboardData &&
                  r(e.clipboardData.getData("text/plain"), t, i);
            }),
            (t.paste = r),
          ...
          let c = class extends a.Disposable {
            constructor(e) {
              super(),
                ...
                this.register(
                  (0, a.getDisposeArrayDisposable)(this._linkCacheDisposables)
                ),
                this.register(
                  (0, a.toDisposable)(() => {
            ...
            _fireUnderlineEvent(e, t) {
              ...
              (t ? this._onShowLinkUnderline : this._onHideLinkUnderline).fire(
                r
              );
            }
            _linkLeave(e, t, i) {
            ...
            _linkAtPosition(e, t) {
              const i =
                  e.range.start.y * this._bufferService.cols + e.range.start.x,
            ...
            _positionFromMouseEvent(e, t, i) {
              ...
              if (s)
                return { x: s[0], y: s[1] + this._bufferService.buffer.ydisp };
            }
          ...
          class I extends w.CoreTerminal {
            constructor(e = {}) {
              super(e),
                ...
                (this._onCursorMove = this.register(new v.EventEmitter())),
                (this.onCursorMove = this._onCursorMove.event),
                (this._onKey = this.register(new v.EventEmitter())),
                (this.onKey = this._onKey.event),
                (this._onRender = this.register(new v.EventEmitter())),
                (this.onRender = this._onRender.event),
                (this._onSelectionChange = this.register(new v.EventEmitter())),
                (this.onSelectionChange = this._onSelectionChange.event),
                (this._onTitleChange = this.register(new v.EventEmitter())),
                (this.onTitleChange = this._onTitleChange.event),
                (this._onBell = this.register(new v.EventEmitter())),
                (this.onBell = this._onBell.event),
                (this._onFocus = this.register(new v.EventEmitter())),
                (this._onBlur = this.register(new v.EventEmitter())),
                (this._onA11yCharEmitter = this.register(new v.EventEmitter())),
                (this._onA11yTabEmitter = this.register(new v.EventEmitter())),
                (this._onWillOpen = this.register(new v.EventEmitter())),
                this._setup(),
                (this.linkifier2 = this.register(
                  this._instantiationService.createInstance(b.Linkifier2)
                )),
                this.linkifier2.registerLinkProvider(
                  this._instantiationService.createInstance(B.OscLinkProvider)
                ),
                    ...
                    case 1:
                      if ("ansi" === e)
                        this._themeService.modifyColors(
                          (e) => (e.ansi[t.index] = E.rgba.toColor(...t.color))
                        );
                      else {
                        const i = e;
                        this._themeService.modifyColors(
                          (e) => (e[i] = E.rgba.toColor(...t.color))
                        );
                      }
                      break;
                    case 2:
            ...
            _handleTextAreaFocus(e) {
              this.coreService.decPrivateModes.sendFocus &&
                this.coreService.triggerDataEvent(o.C0.ESC + "[I"),
            ...
            _handleTextAreaBlur() {
              (this.textarea.value = ""),
                ...
                this.coreService.decPrivateModes.sendFocus &&
                  this.coreService.triggerDataEvent(o.C0.ESC + "[O"),
            ...
            _initGlobal() {
              this._bindKeys(),
                this.register(
                  (0, l.addDisposableDomListener)(this.element, "copy", (e) => {
                    this.hasSelection() &&
                      (0, n.copyHandler)(e, this._selectionService);
                  })
                );
              const e = (e) =>
                (0, n.handlePasteEvent)(e, this.textarea, this.coreService);
              this.register(
                (0, l.addDisposableDomListener)(this.textarea, "paste", e)
              ),
                this.register(
                  (0, l.addDisposableDomListener)(this.element, "paste", e)
                ),
                c.isFirefox
                  ? this.register(
                ...
                c.isLinux &&
                  this.register(
                    (0, l.addDisposableDomListener)(
                      ...
                      (e) => {
                        1 === e.button &&
                          (0, n.moveTextAreaUnderMouseCursor)(
                            e,
                            this.textarea,
                            this.screenElement
                          );
            ...
            open(e) {
              ...
              (this._viewportElement = O.createElement("div")),
                ...
                this.register(
                  (0, l.addDisposableDomListener)(this.textarea, "focus", (e) =>
                    this._handleTextAreaFocus(e)
                  )
                ),
                this.register(
                  (0, l.addDisposableDomListener)(this.textarea, "blur", () =>
                ...
                (this._themeService = this._instantiationService.createInstance(
                  M.ThemeService
                )),
                this._instantiationService.setService(
                  S.IThemeService,
              ...
              this.register(
                this.coreMouseService.onProtocolChange((e) => {
                  e
                    ...
                    16 & e
                      ? s.wheel ||
                        (t.addEventListener("wheel", r.wheel, { passive: !1 }),
                        (s.wheel = r.wheel))
                      : (t.removeEventListener("wheel", s.wheel),
                        (s.wheel = null)),
                    2 & e
                      ? s.mouseup || (s.mouseup = r.mouseup)
                      : (this._document.removeEventListener(
                          "mouseup",
                          s.mouseup
                        ),
                        (s.mouseup = null)),
                    4 & e
                      ? s.mousedrag || (s.mousedrag = r.mousedrag)
                      : (this._document.removeEventListener(
                          "mousemove",
                          s.mousedrag
                        ),
                ...
                (this.coreMouseService.activeProtocol =
                  this.coreMouseService.activeProtocol),
                this.register(
                  (0, l.addDisposableDomListener)(t, "mousedown", (e) => {
                    if (
                      (e.preventDefault(),
                      this.focus(),
                      this.coreMouseService.areMouseEventsActive &&
            ...
            hasSelection() {
              return (
                !!this._selectionService && this._selectionService.hasSelection
              );
            }
            select(e, t, i) {
            ...
            _keyDown(e) {
              ...
              if ((this.updateCursorStyle(e), 3 === i.type || 2 === i.type)) {
                const t = this.rows - 1;
                return (
                  this.scrollLines(2 === i.type ? -t : t), this.cancel(e, !0)
                );
              }
              return (
              ...
              if (0 !== this.buffer.ybase || 0 !== this.buffer.y) {
                ...
                for (let e = 1; e < this.rows; e++)
                  this.buffer.lines.push(
                    this.buffer.getBlankLine(g.DEFAULT_ATTR_DATA)
                  );
                this.refresh(0, this.rows - 1),
                  this._onScroll.fire({
          ...
          let c = class extends n.Disposable {
            ...
            _handleScroll(e) {
              ...
              if (this._ignoreNextScrollEvent)
                return (
                  (this._ignoreNextScrollEvent = !1), void this._scrollLines(0)
                );
              const t =
            ...
            _refreshStyle(e) {
              ...
              if (t < 0 || t >= this._bufferService.rows)
                ...
                i ||
                  ...
                  (i.style.top =
                    t * this._renderService.dimensions.css.cell.height + "px"),
        ...
        9504: (e, t, i) => {
          ...
          t.moveToCellSequence = function (e, t, i, s) {
            ...
            let d;
            if (l === t)
              return (d = o > e ? "D" : "C"), c(Math.abs(o - e), h(d, s));
            d = l > t ? "D" : "C";
            ...
            g = class extends d.Disposable {
              constructor(e, t, i, s, r, o, h, c, _, f) {
                super(),
                  ...
                  (this._themeService = f),
                  (this._terminalClass = v++),
                  (this._rowElements = []),
                  ...
                  (this._rowContainer = document.createElement("div")),
                  this._rowContainer.classList.add("xterm-rows"),
                  ...
                  this._selectionContainer.classList.add("xterm-selection"),
                  this._selectionContainer.setAttribute("aria-hidden", "true"),
                  (this.dimensions = (0, a.createRenderDimensions)()),
                  ...
                  this._element.classList.add(u + this._terminalClass),
                  ...
                  this.register(
                    (0, d.toDisposable)(() => {
                      this._element.classList.remove(u + this._terminalClass),
              ...
              _injectCss(e) {
                ...
                (t += `${
                ...
                } .xterm-rows .xterm-dim { color: ${
                  c.color.multiplyOpacity(e.foreground, 0.5).css
                };}`),
                  (t += `${this._terminalSelector} span:not(.${n.BOLD_CLASS}) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.${n.BOLD_CLASS} { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.${n.ITALIC_CLASS} { font-style: italic;}`),
                  (t +=
                  ...
                  (t +=
                    ...
                    `  color: ${e.cursor.css}; }}`),
                  (t +=
                    `${this._terminalSelector} .xterm-rows:not(.xterm-focus) .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_BLOCK_CLASS} ,${this._terminalSelector} .xterm-rows:not(.xterm-focus) .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_BAR_CLASS} ,${this._terminalSelector} .xterm-rows:not(.xterm-focus) .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_UNDERLINE_CLASS} { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .xterm-rows.xterm-focus .${n.CURSOR_CLASS}.${n.CURSOR_BLINK_CLASS}:not(.${n.CURSOR_STYLE_BLOCK_CLASS}) { animation: blink_box_shadow_` +
                    this._terminalClass +
                    " 1s step-end infinite;}" +
                    `${this._terminalSelector} .xterm-rows.xterm-focus .${n.CURSOR_CLASS}.${n.CURSOR_BLINK_CLASS}.${n.CURSOR_STYLE_BLOCK_CLASS} { animation: blink_block_` +
                    this._terminalClass +
                    " 1s step-end infinite;}" +
                    `${this._terminalSelector} .xterm-rows.xterm-focus .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_BLOCK_CLASS} {` +
                    ` background-color: ${e.cursor.css};` +
                    ` color: ${e.cursorAccent.css};}` +
                    `${this._terminalSelector} .xterm-rows .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_BAR_CLASS} {` +
                    ` box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}` +
                    `${this._terminalSelector} .xterm-rows .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_UNDERLINE_CLASS} {` +
                ...
                for (const [i, s] of e.ansi.entries())
                  t += `${this._terminalSelector} .xterm-fg-${i} { color: ${
                    s.css
                  }; }${this._terminalSelector} .xterm-fg-${i}.${
                    n.DIM_CLASS
                  } { color: ${c.color.multiplyOpacity(s, 0.5).css}; }${
                    this._terminalSelector
                  } .xterm-bg-${i} { background-color: ${s.css}; }`;
                (t += `${this._terminalSelector} .xterm-fg-${
                  ...
                  c.color.multiplyOpacity(c.color.opaque(e.background), 0.5).css
                ...
                for (let n = e; n <= t; n++) {
                  ...
                  (this._cellToRowElements[n] &&
                    this._cellToRowElements[n].length ===
                      this._bufferService.cols) ||
                    (this._cellToRowElements[n] = new Int16Array(
                      this._bufferService.cols
                    )),
                    e.replaceChildren(
              ...
              _setCellUnderline(e, t, i, s, r, n) {
                ...
                if (
                  ...
                  for (; e !== t || i !== s; ) {
                    ...
                    s && (s.style.textDecoration = n ? "underline" : "none"),
                      ++e >= r && ((e = 0), i++);
                  }
              }
            };
        ...
        3787: function (e, t, i) {
          ...
          (t.BOLD_CLASS = "xterm-bold"),
            ...
            (t.OVERLINE_CLASS = "xterm-overline"),
          ...
          let f = class {
            ...
            createRow(e, i, s, r, a, h, l, _, f) {
              ...
              for (; b < S; b++) {
                ...
                if (
                  ...
                  S &&
                    ((E.style.display = "inline"), a >= b && a <= y && (a = b)),
                  !this._coreService.isCursorHidden && s && b === a)
                )
                  switch (
                    (E.classList.add(t.CURSOR_CLASS),
                    h && E.classList.add(t.CURSOR_BLINK_CLASS),
                    r)
                  ) {
                    case "bar":
                ...
                if (
                  (w.isBold() && E.classList.add(t.BOLD_CLASS),
                  w.isItalic() && E.classList.add(t.ITALIC_CLASS),
                  w.isDim() && E.classList.add(t.DIM_CLASS),
                  w.isInvisible()
                    ? (E.textContent = o.WHITESPACE_CELL_CHAR)
                    : (E.textContent = w.getChars() || o.WHITESPACE_CELL_CHAR),
                  w.isUnderline() &&
                    (E.classList.add(
                  ...
                  if (w.isUnderlineColorRGB())
                    ...
                    this._optionsService.rawOptions
                      ...
                      e < 8 &&
                      (e += 8),
                      (E.style.textDecorationColor = m.ansi[e].css);
                  }
                w.isOverline() &&
                  (E.classList.add(t.OVERLINE_CLASS),
                  " " === E.textContent && (E.textContent = " ")),
                  ...
                  (e) => {
                    ("top" !== e.options.layer && T) ||
                      (e.backgroundColorRGB &&
                        ((D = 50331648),
                        (R = (e.backgroundColorRGB.rgba >> 8) & 16777215),
                        (x = e.backgroundColorRGB)),
                      e.foregroundColorRGB &&
                        ((k = 50331648),
                        (L = (e.foregroundColorRGB.rgba >> 8) & 16777215),
                ...
                switch (
                  (T ||
                    (m.selectionForeground &&
                      M &&
                      ((k = 50331648),
                      (L = (m.selectionForeground.rgba >> 8) & 16777215),
                  ...
                  M &&
                    ...
                    (T = !0)),
                  T && E.classList.add("xterm-decoration-top"),
                  D)
                ) {
                  case 16777216:
                  case 33554432:
                    ...
                    break;
                  case 50331648:
                    (O = c.rgba.toColor(R >> 16, (R >> 8) & 255, 255 & R)),
                      this._addStyle(
                        E,
                        `background-color:#${v((R >>> 0).toString(16), "0", 6)}`
                      );
                    break;
                  default:
                    A
                      ? ((O = m.foreground),
                        E.classList.add(`xterm-bg-${n.INVERTED_DEFAULT_COLOR}`))
                      : (O = m.background);
                }
                switch (
                  (x || (w.isDim() && (x = c.color.multiplyOpacity(O, 0.5))), k)
                ) {
                  case 16777216:
                  case 33554432:
                    w.isBold() &&
                  ...
                  case 50331648:
                    ...
                    this._applyMinimumContrast(E, O, e, w, x, B) ||
                      this._addStyle(E, `color:#${v(L.toString(16), "0", 6)}`);
                    break;
                  default:
                    this._applyMinimumContrast(
                      E,
            ...
            _applyMinimumContrast(e, t, i, s, r, n) {
              ...
              return (
                r ||
                  n ||
                  (o = this._themeService.colors.contrastCache.getColor(
                    t.rgba,
                    i.rgba
                  )),
                void 0 === o &&
            ...
            static _mergeRanges(e, t) {
              ...
              for (let s = 0; s < e.length; s++) {
                ...
                if (i) {
                  ...
                  if (t[1] <= r[1])
                    return (
                      (e[s - 1][1] = Math.max(t[1], r[1])), e.splice(s, 1), e
                    );
                  e.splice(s, 1), s--;
                } else {
        ...
        8934: function (e, t, i) {
            ...
            getMouseReportCoords(e, t) {
              ...
              if (
                !(
                  ...
                  i[0] < 0 ||
                  i[1] < 0 ||
                  i[0] >= this._renderService.dimensions.css.canvas.width ||
                  i[1] >= this._renderService.dimensions.css.canvas.height
                )
              )
                return {
                  col: Math.floor(
                    i[0] / this._renderService.dimensions.css.cell.width
                  ),
                  row: Math.floor(
                    i[1] / this._renderService.dimensions.css.cell.height
                  ),
                  x: Math.floor(i[0]),
                  y: Math.floor(i[1]),
                };
          ...
          (a = s([r(0, n.IRenderService), r(1, n.ICharSizeService)], a)),
            (t.MouseService = a);
        },
        3230: function (e, t, i) {
          var s =
          ...
          let u = class extends a.Disposable {
            constructor(e, t, i, s, r, a, l, d) {
              if (
                ...
                (this._onRender = this.register(new o.EventEmitter())),
                (this.onRender = this._onRender.event),
                (this._onRefreshRequest = this.register(new o.EventEmitter())),
                (this.onRefreshRequest = this._onRefreshRequest.event),
                this.register({
                  dispose: () => {
                    var e;
                    return null === (e = this._renderer) || void 0 === e
                      ? void 0
                      : e.dispose();
                  },
                }),
                ...
                (this._screenDprMonitor = new h.ScreenDprMonitor(l.window)),
                this._screenDprMonitor.setListener(() =>
                ...
                this.register(
                  (0, c.addDisposableDomListener)(l.window, "resize", () =>
                    this.handleDevicePixelRatioChange()
                  )
                ),
            ...
            _fireOnCanvasResize() {
              this._renderer &&
                ((this._renderer.dimensions.css.canvas.width ===
                  this._canvasWidth &&
                  this._renderer.dimensions.css.canvas.height ===
                    this._canvasHeight) ||
            ...
            setRenderer(e) {
              var t;
              null === (t = this._renderer) || void 0 === t || t.dispose(),
                (this._renderer = e),
            ...
            clearTextureAtlas() {
              var e, t;
              this._renderer &&
                (null === (t = (e = this._renderer).clearTextureAtlas) ||
                  void 0 === t ||
                  t.call(e),
                this._fullRefresh());
            }
          ...
          let p = class extends u.Disposable {
            constructor(e, t, i, s, r, n, c, l, d) {
              super(),
                ...
                (this._onRedrawRequest = this.register(new h.EventEmitter())),
                (this.onRequestRedraw = this._onRedrawRequest.event),
                (this._onSelectionChange = this.register(new h.EventEmitter())),
                (this.onSelectionChange = this._onSelectionChange.event),
                ...
                this.enable(),
                (this._model = new o.SelectionModel(this._bufferService)),
            ...
            _getMouseBufferCoords(e) {
              ...
              if (t)
                return (
                  t[0]--, t[1]--, (t[1] += this._bufferService.buffer.ydisp), t
                );
            }
            ...
            _getWordAt(e, t, i = !0, s = !0) {
              ...
              if (" " === o.charAt(a)) {
                ...
                for (
                  ...
                  t > 0 &&
                  a > 0 &&
                  !this._isCharWordSeparator(n.loadCell(t - 1, this._workCell));
          ...
          let v = class extends h.Disposable {
            ...
            _setTheme(e = {}) {
              ...
              if (
                ...
                (i.ansi[10] = g(e.brightGreen, t.DEFAULT_ANSI_COLORS[10])),
                (i.ansi[11] = g(e.brightYellow, t.DEFAULT_ANSI_COLORS[11])),
                (i.ansi[12] = g(e.brightBlue, t.DEFAULT_ANSI_COLORS[12])),
                (i.ansi[13] = g(e.brightMagenta, t.DEFAULT_ANSI_COLORS[13])),
                (i.ansi[14] = g(e.brightCyan, t.DEFAULT_ANSI_COLORS[14])),
                (i.ansi[15] = g(e.brightWhite, t.DEFAULT_ANSI_COLORS[15])),
                e.extendedAnsi)
              ) {
        ...
        6349: (e, t, i) => {
          ...
          class n extends r.Disposable {
            ...
            splice(e, t, ...i) {
              ...
              if (
                (i.length &&
                  this.onInsertEmitter.fire({ index: e, amount: i.length }),
        ...
        8969: (e, t, i) => {
          ...
          class m extends s.Disposable {
            constructor(e) {
              super(),
                ...
                (this._charsetService =
                  this._instantiationService.createInstance(u.CharsetService)),
                this._instantiationService.setService(
                  r.ICharsetService,
                  this._charsetService
                ),
                (this._oscLinkService =
                  this._instantiationService.createInstance(p.OscLinkService)),
                this._instantiationService.setService(
                  r.IOscLinkService,
                  this._oscLinkService
                ),
                ...
                this.register(
                  (0, l.forwardEvent)(this.coreService.onData, this._onData)
                ),
                this.register(
                  (0, l.forwardEvent)(this.coreService.onBinary, this._onBinary)
                ),
                this.register(
                ...
                (this._writeBuffer = this.register(
                  new g.WriteBuffer((e, t) => this._inputHandler.parse(e, t))
                )),
                this.register(
                  (0, l.forwardEvent)(
                ...
                this.register(
                  (0, s.toDisposable)(() => {
                    var e;
                    null === (e = this._windowsWrappingHeuristics) ||
                      void 0 === e ||
                      e.dispose(),
                      (this._windowsWrappingHeuristics = void 0);
                  })
                );
            }
            get onScroll() {
            ...
            _handleWindowsPtyOptionChange() {
              ...
              i && void 0 !== i.buildNumber && void 0 !== i.buildNumber
                ? (t = !!("conpty" === i.backend && i.buildNumber < 21376))
                : this.optionsService.rawOptions.windowsMode && (t = !0),
                t
            ...
            _enableWindowsWrappingHeuristics() {
              if (!this._windowsWrappingHeuristics) {
                ...
                e.push(
                  ...
                  (this._windowsWrappingHeuristics = (0, s.toDisposable)(() => {
        ...
        5435: function (e, t, i) {
          ...
          class E extends h.Disposable {
            ...
            deleteLines(e) {
              ...
              for (
                s =
                  ...
                  this._activeBuffer.scrollBottom,
                  s =
                    this._bufferService.rows - 1 + this._activeBuffer.ybase - s;
                t--;
              ...
              return (
                e.params[0] > 0 ||
                  ...
                  this._is("screen")
                    ...
                    : this._is("linux") &&
                      this._coreService.triggerDataEvent(n.C0.ESC + "[?6c")),
                !0
              );
            }
            ...
            _is(e) {
              return (
                0 === (this._optionsService.rawOptions.termName + "").indexOf(e)
              );
            }
            setMode(e) {
              ...
              for (let r = 0; r < t; r++)
                (i = e.params[r]),
                  i >= 30 && i <= 37
                    ...
                    : 39 === i
                    ? ((s.fg &= -67108864),
                      (s.fg |= 16777215 & l.DEFAULT_ATTR_DATA.fg))
                    : 49 === i
                    ? ((s.bg &= -67108864),
                      (s.bg |= 16777215 & l.DEFAULT_ATTR_DATA.bg))
                    : 38 === i || 48 === i || 58 === i
                    ...
                    ? ((s.fg &= -67108864),
                      ...
                      (s.bg &= -67108864),
                      (s.bg |= 16777215 & l.DEFAULT_ATTR_DATA.bg))
                    : this._logService.debug("Unknown SGR attribute: %d.", i);
              return !0;
            }
            deviceStatus(e) {
              switch (e.params[0]) {
            ...
            setScrollRegion(e) {
              ...
              return (
                (e.length < 2 ||
                  (i = e.params[1]) > this._bufferService.rows ||
                  0 === i) &&
                  (i = this._bufferService.rows),
                i > t &&
            ...
            _createHyperlink(e, t) {
              ...
              return (
                ...
                (this._curAttrData.extended.urlId =
                  this._oscLinkService.registerLink({ id: s, uri: t })),
            ...
            restoreIndexedColor(e) {
              ...
              for (let e = 0; e < i.length; ++e)
                if (/^\d+$/.exec(i[e])) {
                  ...
                  0 <= s && s < 256 && t.push({ type: 2, index: s });
                }
              return t.length && this._onColor.fire(t), !0;
            }
            restoreFgColor(e) {
            ...
            screenAlignmentPattern() {
              ...
              return (
                this._dirtyRowTracker.markAllDirty(), this._setCursor(0, 0), !0
              );
            }
            requestStatusString(e, t) {
              ...
              return ((e) => (
                ...
                '"q' === e
                  ...
                  : " q" === e
                  ? `P1$r${
                      { block: 2, underline: 4, bar: 6 }[s.cursorStyle] -
                      (s.cursorBlink ? 1 : 0)
                    } q`
                  : "P0$r"
              );
        ...
        6106: (e, t) => {
          ...
          t.SortedList = class {
            ...
            delete(e) {
              ...
              if (((i = this._search(t, 0, this._array.length - 1)), -1 === i))
                return !1;
            ...
            *getKeyIterator(e) {
              if (
                0 !== this._array.length &&
                ((i = this._search(e, 0, this._array.length - 1)),
            ...
            (t.Buffer = class {
              constructor(e, t, i) {
                (this._hasScrollback = e),
                  ...
                  (this.savedY = 0),
                  (this.savedX = 0),
                  (this.savedCurAttrData = r.DEFAULT_ATTR_DATA.clone()),
              ...
              getNullCell(e) {
                return (
                  e
                    ...
                    : ((this._nullCell.fg = 0),
                      (this._nullCell.bg = 0),
                      (this._nullCell.extended = new l.ExtendedAttrs())),
                  this._nullCell
                );
              }
              getWhitespaceCell(e) {
                return (
                  e
                    ...
                    : ((this._whitespaceCell.fg = 0),
                      ...
                      (this._whitespaceCell.extended = new l.ExtendedAttrs())),
              ...
              resize(e, t) {
                ...
                if (
                  (n > this.lines.maxLength && (this.lines.maxLength = n),
                  this.lines.length > 0)
                ) {
                  if (this._cols < e)
                  ...
                  if (this._rows < t)
                    for (let s = this._rows; s < t; s++)
                      this.lines.length < t + this.ybase &&
                        ...
                        void 0 !==
                          this._optionsService.rawOptions.windowsPty.buildNumber
                          ? this.lines.push(new r.BufferLine(e, i))
                          : this.ybase > 0 &&
              ...
              _reflowLargerAdjustViewport(e, t, i) {
                ...
                for (; n-- > 0; )
                  0 === this.ybase
                    ? (this.y > 0 && this.y--,
                      this.lines.length < t &&
                        this.lines.push(new r.BufferLine(e, s)))
              ...
              _reflowSmaller(e, t) {
                ...
                for (let o = this.lines.length - 1; o >= 0; o--) {
                  ...
                  v.length > 0 &&
                    (s.push({ start: o + c.length + n, newLines: v }),
                    (n += v.length)),
                    c.push(...v);
                  let g = _.length - 1,
                    p = _[g];
                  ...
                  for (; S >= 0; ) {
                    ...
                    if (void 0 === c[g]) break;
                    if (
                      (c[g].copyCellsFrom(c[S], m - e, p - e, e, !0),
                      (p -= e),
                      0 === p && (g--, (p = _[g])),
                      (m -= e),
                      0 === m)
                ...
                if (s.length > 0) {
                  ...
                  let h = 0;
                  for (
                    let c = Math.min(this.lines.maxLength - 1, i + n - 1);
                    c >= 0;
                    c--
                  )
                    if (a && a.start > r + h) {
                      ...
                      c++,
                        e.push({ index: r + 1, amount: a.newLines.length }),
                        (h += a.newLines.length),
                        (a = s[++o]);
        ...
        8437: (e, t, i) => {
          ...
          class h {
            ...
            addCodepointToCell(e, t) {
              ...
              2097152 & i
                ? (this._combined[e] += (0, s.stringFromCodePoint)(t))
                : (2097151 & i
                    ? ((this._combined[e] =
                        (0, s.stringFromCodePoint)(2097151 & i) +
              ...
              if (
                ((e %= this.length) &&
                  ...
                  this.setCellFromCodePoint(
                    ...
                    (null == s ? void 0 : s.extended) || new o.ExtendedAttrs()
                  ),
                t < this.length - e)
              ) {
            ...
            resize(e, t) {
              ...
              return (
                (this.length = e), 4 * i * 2 < this._data.buffer.byteLength
              );
            }
            cleanupMemory() {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.reflowLargerGetLinesToRemove = function (e, t, s, r, n) {
              ...
              for (let a = 0; a < e.length - 1; a++) {
                ...
                for (
                  let e = l.length - 1;
                  e > 0 && (e > d || 0 === l[e].getTrimmedLength());
                  e--
                )
                  v++;
          ...
          class o extends n.Disposable {
            constructor(e, t) {
              super(),
                (this._optionsService = e),
                (this._bufferService = t),
                (this._onBufferActivate = this.register(new r.EventEmitter())),
            ...
            (t.StringToUtf32 = class {
              ...
              decode(e, t) {
                ...
                if (this._interim) {
                  ...
                  56320 <= i && i <= 57343
                    ? (t[s++] =
                        1024 * (this._interim - 55296) + i - 56320 + 65536)
              ...
              decode(e, t) {
                ...
                for (; d < i; ) {
                  ...
                  if (((s = e[d++]), s < 128)) t[a++] = s;
                    ...
                    if (d >= i)
                      return (this.interim[0] = s), (this.interim[1] = r), a;
                    if (((n = e[d++]), 128 != (192 & n))) {
                      d--;
                      continue;
                    }
            ...
            unhook(e, t = !0) {
              if (this._active.length) {
                ...
                if (
                  ...
                  for (
                    ;
                    s >= 0 && ((i = this._active[s].unhook(e)), !0 !== i);
                    s--
                  )
          ...
          (t.OscParser = class {
            ...
            _put(e, t, i) {
              if (this._active.length)
                ...
                this._handlerFb(this._id, "PUT", (0, r.utf32ToString)(e, t, i));
            }
            start() {
                ...
                if (3 !== this._state)
                  if (
                    ...
                    if (
                      ...
                      for (
                        ;
                        s >= 0 && ((i = this._active[s].end(e)), !0 !== i);
                        s--
                      )
                        if (i instanceof Promise)
                          return (
          ...
          class s {
            ...
            toArray() {
              ...
              for (let t = 0; t < this.length; ++t) {
                ...
                s - i > 0 &&
                  e.push(Array.prototype.slice.call(this._subParams, i, s));
              }
              return e;
            }
            reset() {
            ...
            hasSubParams(e) {
              return (
                (255 & this._subParamsIdx[e]) - (this._subParamsIdx[e] >> 8) > 0
              );
            }
            getSubParams(e) {
          ...
          let c = class extends h.Disposable {
            constructor(e) {
              super(),
                ...
                (this.buffers = this.register(new o.BufferSet(e, this)));
            }
            get buffer() {
              return this.buffers.active;
            }
        ...
        2585: (e, t, i) => {
          ...
          (t.IBufferService = (0, s.createDecorator)("BufferService")),
            ...
            ((r = t.LogLevelEnum || (t.LogLevelEnum = {}))[(r.DEBUG = 0)] =
              "DEBUG"),
            (r[(r.INFO = 1)] = "INFO"),
            (r[(r.WARN = 2)] = "WARN"),
            (r[(r.ERROR = 3)] = "ERROR"),
        ...
        e.Terminal = class {
          constructor(e) {
            ...
            for (const e in this._core.options) {
              const t = { get: i.bind(this, e), set: s.bind(this, e) };
          ...
          get parser() {
            return (
              this._parser || (this._parser = new n.ParserApi(this._core)),
              this._parser
            );
          }
          get unicode() {
          ...
          get buffer() {
            return (
              this._buffer ||
                (this._buffer = new h.BufferNamespaceApi(this._core)),
              this._buffer
            );
          }
          get markers() {
